...
const Navbar = () => {
  ...
  return (
    <header className="flex justify-between items-center h-16 bg-white px-4 py-2 mt-4 shadow-md border border-gray-200 rounded-4xl mx-4 relative">
      ...
      {isOpen && (
        <div className="fixed top-10 left-0 right-0 bottom-0 bg-opacity-50 flex justify-center items-start z-50">
          <div className="bg-white w-full max-w-md rounded-lg shadow-lg p-6 mt-10 relative">
            {/* Close Button */}
            <button
